...
Circuit 9.2 shows a circuit of dual motor driver to drive bipolar stepper motor. $In_{1}$ and $In_{2}$ will control $M_{1}$ output while $In_{3}$ and $In_{4}$ will control $M_{2}$ output.
<br/>
...
* https://github.com/i9Workshop/StarterBoardV1-PIC16F1783-StepperMotorBipolar
<br/>
