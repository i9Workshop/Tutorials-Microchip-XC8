...
![Schematic-Reset-Button](https://github.com/user-attachments/assets/02a828a1-7b05-46e8-a27a-f7773e3b8326)
<br/>
Schematic 0.2
<br/>
...
* If R1 is less than $7.1k\Omega$, make sure pull down current accross it when button is pressed not high to cause interruption of MCU current operation.
<br/>
