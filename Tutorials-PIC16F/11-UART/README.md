...
A software is also needed to monitor serial data transmitted or received in a computer. Thus, software can be developed to monitor and control a MCU from a computer. Download example serial monitor software using [Java](https://github.com/i9Workshop/Java-SerialMonitorV1) or [Visual Basic](https://github.com/i9Workshop/VB.NET-SerialMonitorV1).
